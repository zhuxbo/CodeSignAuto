        ...
        bool externalProductStatePresent = false)
    {
        ...
        return new AutoLogonRemediationInspection(
            ...
            externalProductStatePresent || valueNames.Any(name =>
                name.StartsWith("CodeSignAuto", StringComparison.OrdinalIgnoreCase)),
...
{
    private const string ServiceName = "CodeSignAuto.Service";
    ...
    public static bool Exists()
    {
        try
        {
            ...
            return lookup.ServiceExists(ServiceName) ||
                ...
                WindowsPathSafety.EntryExists(Path.Combine(programDataRoot, "CodeSignAuto")) ||
                WindowsPathSafety.EntryExists(Path.Combine(programFilesRoot, "CodeSignAuto")) ||
                WindowsPathSafety.EntryExists(Path.Combine(profilesRoot, "CodeSignAutoAgent")) ||
...
internal sealed class WindowsAutoLogonRemediationPlatform : IAutoLogonRemediationPlatform
{
    ...
    private const string ManagedAgentUser = "CodeSignAutoAgent";
