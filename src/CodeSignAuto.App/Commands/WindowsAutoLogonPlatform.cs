...
internal sealed class OwnedLsaSecretTransaction
{
    ...
    {
        const string prefix = "CodeSignAuto/v1/";
...
{
    internal const string LsaOwnerReceiptValueName = "CodeSignAutoLsaDefaultPasswordOwner";
    private const string OwnerValueName = "CodeSignAutoAgentUserOwner";
    private const string PriorUserValueName = "CodeSignAutoPriorDefaultUserName";
    private const string PriorDomainValueName = "CodeSignAutoPriorDefaultDomainName";
    private const string PriorAutoValueName = "CodeSignAutoPriorAutoAdminLogon";
    private const string PriorUserPresentValueName = "CodeSignAutoPriorDefaultUserNamePresent";
    private const string PriorDomainPresentValueName = "CodeSignAutoPriorDefaultDomainNamePresent";
    private const string PriorAutoPresentValueName = "CodeSignAutoPriorAutoAdminLogonPresent";
...
{
    private const string AgentTaskName = "CodeSignAuto.Agent";
    private const string WinlogonPath = @"SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon";
    private const string OwnerValueName = "CodeSignAutoAgentUserOwner";
    private const string PriorUserValueName = "CodeSignAutoPriorDefaultUserName";
    private const string PriorDomainValueName = "CodeSignAutoPriorDefaultDomainName";
    ...
    private const string PriorDomainPresentValueName = "CodeSignAutoPriorDefaultDomainNamePresent";
    private const string PriorAutoPresentValueName = "CodeSignAutoPriorAutoAdminLogonPresent";
    private const string UninstallStateValueName = "CodeSignAutoUninstallState";
    private const string UninstallSidValueName = "CodeSignAutoUninstallSid";
    private const string UninstallAccountValueName = "CodeSignAutoUninstallAccount";
    private const string UninstallProfileValueName = "CodeSignAutoUninstallProfile";
...
internal static class WindowsUserProfile
{
    ...
    private const string OwnerValue = "CodeSignAutoProfileOwner";
    private const string InstallInstanceValue = "CodeSignAutoProfileInstallInstanceId";
    private const string SidValue = "CodeSignAutoProfileSid";
    private const string AccountValue = "CodeSignAutoProfileAccount";
    private const string PathValue = "CodeSignAutoProfilePath";
    private const int MaxPath = 260;
    ...
    internal static ProvisionedAgentUser CreateOwned(ProvisionedAgentUser user, string ownerMarker)
    {
        ...
        try
        {
            ...
            var instanceId = ownerMarker["CodeSignAuto/v1/".Length..];
    ...
    private static void ValidateIdentity(ProvisionedAgentUser user, string ownerMarker)
    {
        ...
        const string ownerPrefix = "CodeSignAuto/v1/";
...
{
    private const string ManagedComment = "CodeSignAuto signing agent";
