...
{
    internal const string ProductDirectoryName = "CodeSignAuto";
    internal const string ExecutableFileName = "CodeSignAuto.exe";
...
internal sealed class WindowsInstallMediaVerifier : IInstallMediaVerifier
{
    ...
    private const string VerifyCatalogThenRunScriptCommand =
        ...
        "-FilesToSkip @('release-files.cat','CodeSignAuto.exe') -ErrorAction Stop;" +
