...
{
    private const string Light = "/CodeSignAuto;component/UI/Themes/Colors.Light.xaml";
    private const string Dark = "/CodeSignAuto;component/UI/Themes/Colors.Dark.xaml";
