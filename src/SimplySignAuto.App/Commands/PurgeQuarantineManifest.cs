...
{
    public const string OwnerMarker = "SimplySignAuto/Purge/v1";
    ...
    public static PurgeQuarantineManifest Validate(PurgeQuarantineManifest manifest)
    {
        ...
        if (manifest.Version != 1 ||
            ...
            !string.Equals(Path.GetFileName(manifest.ExecutablePath), "SimplySignAuto.exe", StringComparison.OrdinalIgnoreCase) ||
        ...
        for (var index = 0; index < manifest.StagingRoots.Count; index++)
        {
            ...
            if (string.IsNullOrEmpty(volume) ||
                ...
                !string.Equals(
                    ...
                    $".SimplySignAuto.quarantine.{manifest.OperationId}.{index}",
                    StringComparison.Ordinal) ||
