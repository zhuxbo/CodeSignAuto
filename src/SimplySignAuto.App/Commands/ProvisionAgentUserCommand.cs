...
public sealed class ProvisionAgentUserOrchestrator
{
        ...
        AgentUserProvisionReadback readback)
    {
        ...
        return ownerMarker["SimplySignAuto/v1/".Length..];
    }
    ...
    private static bool IsOwnerMarker(string value) =>
        value.StartsWith("SimplySignAuto/v1/", StringComparison.Ordinal) &&
        InstallOwnershipMarker.IsInstanceId(value["SimplySignAuto/v1/".Length..]);
