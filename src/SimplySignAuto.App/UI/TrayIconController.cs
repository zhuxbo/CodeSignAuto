...
public sealed class TrayIconController : IDisposable
{
    ...
    private void EvaluateAndDisplayNotifications()
    {
        ...
        IReadOnlyList<SimplySignAuto.Protocol.TerminalJobEventItem>? terminalJobs =
...
internal sealed class WindowsNotifyIconPlatform : ITrayIconPlatform
{
    ...
    public void Initialize(IReadOnlyList<TrayMenuEntry> entries, string statusText)
    {
        ...
        try
        {
            var resource = System.Windows.Application.GetResourceStream(
                new Uri("pack://application:,,,/SimplySignAuto;component/UI/Resources/app.ico", UriKind.Absolute))
    ...
    public void SetStatus(string statusText)
    {
        ...
        var text = _uiTestIdentity ?? $"SimplySignAuto - {statusText}";
