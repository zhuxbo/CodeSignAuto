    ...
    string DigestAlgorithm)
{
        ...
        IReadOnlyDictionary<string, JsonElement> values)
    {
        ...
        if (!global::SimplySignAuto.Core.Jobs.CertificateSerialNumber.TryNormalize(certificateSerialNumber, out var normalizedCertificateSerialNumber) ||
    ...
    {
        if (!global::SimplySignAuto.Core.Jobs.CertificateSerialNumber.TryNormalize(value, out var normalized))
        {
