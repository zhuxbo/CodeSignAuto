...
{
    private const string MetadataResourceName = "SimplySignAuto.Setup.Metadata.json";
    private const string PayloadResourceName = "SimplySignAuto.Setup.Payload.zip";
...
internal sealed class WindowsSetupWorkspace(string parentRoot) : ISetupWorkspace
{
    ...
    public string Create()
    {
        ...
        for (var attempt = 0; attempt < 8; attempt++)
        {
            ...
            var candidate = Path.Combine(parent, "SimplySignAutoSetup-" + nonce);
            try
            {
