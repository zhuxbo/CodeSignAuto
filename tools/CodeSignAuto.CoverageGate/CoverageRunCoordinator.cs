...
namespace CodeSignAuto.Coverage;
...
internal static class CoverageRunContract
{
    ...
    [
        new("CodeSignAuto.Agent.Tests", "tests/CodeSignAuto.Agent.Tests/CodeSignAuto.Agent.Tests.csproj", "CodeSignAuto.Agent.Tests.dll"),
        new("CodeSignAuto.Core.Tests", "tests/CodeSignAuto.Core.Tests/CodeSignAuto.Core.Tests.csproj", "CodeSignAuto.Core.Tests.dll"),
        new("CodeSignAuto.EndToEnd.Tests", "tests/CodeSignAuto.EndToEnd.Tests/CodeSignAuto.EndToEnd.Tests.csproj", "CodeSignAuto.EndToEnd.Tests.dll"),
        new("CodeSignAuto.Protocol.Tests", "tests/CodeSignAuto.Protocol.Tests/CodeSignAuto.Protocol.Tests.csproj", "CodeSignAuto.Protocol.Tests.dll"),
        new("CodeSignAuto.Service.Tests", "tests/CodeSignAuto.Service.Tests/CodeSignAuto.Service.Tests.csproj", "CodeSignAuto.Service.Tests.dll"),
        new("CodeSignAuto.UI.Tests", "tests/CodeSignAuto.UI.Tests/CodeSignAuto.UI.Tests.csproj", "CodeSignAuto.UI.Tests.dll"),
    ];
}
