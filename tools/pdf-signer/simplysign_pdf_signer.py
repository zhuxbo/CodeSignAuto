...
def load_validate_request(path: Path):
    from simplysign_pdf_validator import ValidationRequest
...
def _default_validation_runner(validation_request: Any) -> dict[str, object]:
    from simplysign_pdf_validator import spawn_validate
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if command == "probe":
            ...
            from simplysign_pdf_validator import validate_with_evidence
        ...
        if command == "catalog":
            ...
            from simplysign_pdf_validator import _evidence_failure
