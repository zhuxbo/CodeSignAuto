...
public sealed class AuthenticationTests
{
    ...
    public async Task Real_app_service_entry_loads_aspnet_runtime_before_strict_configuration_validation()
    {
        ...
        var application = Path.Combine(repositoryRoot, "src", "SimplySignAuto.App", "bin", "Release", "net10.0-windows", "SimplySignAuto.dll");
    ...
    private static string FindRepositoryRoot()
    {
        ...
        while (directory is not null && !File.Exists(Path.Combine(directory.FullName, "SimplySignAuto.sln")))
        {
