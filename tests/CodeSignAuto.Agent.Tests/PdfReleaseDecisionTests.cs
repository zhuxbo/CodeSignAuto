...
public sealed class PdfReleaseDecisionTests
{
    ...
    public void Helper_production_change_publishes_pdf_extension()
    {
        ...
        fixture.Commit("initial");
        fixture.Tag("v1.0.0");
        fixture.Write("tools/pdf-signer/CodeSignAuto_pdf_signer.py", "VERSION = '1.0.1'");
        ...
        Assert.Equal(
            ["tools/pdf-signer/CodeSignAuto_pdf_signer.py"],
    ...
    public void Shared_pdf_setup_change_publishes_pdf_extension()
    {
        ...
        fixture.Commit("initial");
        fixture.Tag("v1.0.0");
        fixture.Write("src/CodeSignAuto.Setup/Program.cs", "// setup fix");
        ...
        Assert.True(decision.ReleasePdf);
        Assert.Equal("pdf_inputs_changed", decision.Reason);
        Assert.Equal(["src/CodeSignAuto.Setup/Program.cs"], decision.ChangedPaths);
    }
    ...
    public void Untracked_pdf_setup_input_fails_closed()
    {
        ...
        fixture.Commit("initial");
        fixture.Tag("v1.0.0");
        fixture.Write("src/CodeSignAuto.Setup/NewSetupInput.cs", "// untracked setup input");
    ...
    private sealed class DecisionFixture : IDisposable
    {
        ...
        public static DecisionFixture Create()
        {
            ...
            fixture.Write("tools/pdf-signer/CodeSignAuto_pdf_signer.py", "VERSION = '1.0.0'");
            fixture.Write("tools/pdf-signer/CodeSignAuto_pdf_validator.py", "validator = True");
            ...
            fixture.Write("src/CodeSignAuto.Setup/Program.cs", "// setup");
