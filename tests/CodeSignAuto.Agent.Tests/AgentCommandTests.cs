...
public sealed class AgentCommandTests
{
    ...
    public async Task Missing_configuration_keeps_stable_code_and_original_path_diagnostic()
    {
        ...
        Assert.Contains("exception_type=CodeSignAuto.App.Commands.AgentConfigurationException", error.ToString(), StringComparison.Ordinal);
    ...
    public async Task Startup_failure_prints_the_stable_code_and_full_diagnostic()
    {
        ...
        Assert.Contains("exception_type=CodeSignAuto.Agent.Sessions.AgentStartupException", error.ToString(), StringComparison.Ordinal);
