...
public sealed class PdfSignerTests
{
    ...
    private static ProcessResult Exited(int exitCode, string stdout) =>
        ProcessResult.Exited("CodeSignAutoPdfSigner.exe", exitCode, TimeSpan.Zero, stdout, string.Empty);
    ...
    private sealed class Fixture : IDisposable
    {
        ...
        public Fixture()
        {
            ...
            HelperPath = Path.Combine(Root, "CodeSignAutoPdfSigner.exe");
