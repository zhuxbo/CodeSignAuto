...
public sealed class CoverageGateTests
{
    ...
    public void Exact_thresholds_pass_with_independently_counted_source_lines()
    {
        ...
        Assert.Equal(8500, summary["CodeSignAuto.Core"].BasisPoints);
        Assert.Equal(8500, summary["CodeSignAuto.Service"].BasisPoints);
        Assert.Equal(8500, summary["CodeSignAuto.Protocol"].BasisPoints);
        Assert.Equal(7500, summary["CodeSignAuto.Agent"].BasisPoints);
        Assert.Equal(8000, summary["CodeSignAuto.UI.ViewModels"].BasisPoints);
    }
    ...
    public void Collector_specific_paths_are_unified_and_generated_obj_lines_are_not_product_source()
    {
        var collectorVariant = Report(
            Package("CodeSignAuto.Core", "CodeSignAuto.Core.Sample", 0, 20, "CodeSignAuto.Core/Sample.cs"),
            Package("CodeSignAuto.Service", "CodeSignAuto.Service.Sample", 0, 20, "Sample.cs"),
            Package("CodeSignAuto.Protocol", "CodeSignAuto.Protocol.Sample", 0, 20, "/agent/src/CodeSignAuto.Protocol/Sample.cs"),
            Package("CodeSignAuto.Agent", "CodeSignAuto.Agent.Sample", 0, 20, "CodeSignAuto.Agent/Sample.cs"),
            Package("CodeSignAuto", "CodeSignAuto.App.UI.ViewModels.SampleViewModel", 0, 20, "CodeSignAuto.App/UI/ViewModels/SampleViewModel.cs"));
        var generatedVariant = Report(
            Package(
                "CodeSignAuto.Core",
                "CodeSignAuto.Core.GeneratedRegex",
                0,
                1_000,
                "src/CodeSignAuto.Core/obj/Release/net10.0/Generator/RegexGenerator.g.cs"));

        var summary = CoverageGate.EvaluateXmlReports([ValidReport(), collectorVariant, generatedVariant]);

        Assert.Equal((17, 20, 8500), Result(summary, "CodeSignAuto.Core"));
        Assert.Equal((17, 20, 8500), Result(summary, "CodeSignAuto.Service"));
        Assert.Equal((17, 20, 8500), Result(summary, "CodeSignAuto.Protocol"));
        Assert.Equal((15, 20, 7500), Result(summary, "CodeSignAuto.Agent"));
        Assert.Equal((16, 20, 8000), Result(summary, "CodeSignAuto.UI.ViewModels"));
    }
    ...
    public void Nan_hits_and_unknown_target_fail_closed()
    {
        ...
        var unknown = ValidReport().Replace(
            "name=\"CodeSignAuto.Core\"",
            "name=\"CodeSignAuto.Future\"",
    ...
    {
        var core = Package("CodeSignAuto.Core", "CodeSignAuto.Core.Sample", 17, 20);
    ...
    {
        var lowCore = Package("CodeSignAuto.Core", "CodeSignAuto.Core.Sample", 8_499, 10_000);
        var report = Report(
            lowCore,
            Package("CodeSignAuto.Service", "CodeSignAuto.Service.Sample", 17, 20),
            Package("CodeSignAuto.Protocol", "CodeSignAuto.Protocol.Sample", 17, 20),
            Package("CodeSignAuto.Agent", "CodeSignAuto.Agent.Sample", 15, 20),
            Package(
                "CodeSignAuto",
                "CodeSignAuto.App.UI.ViewModels.Sample",
                16,
                20,
                "src/CodeSignAuto.App/UI/ViewModels/SampleViewModel.cs"));
    ...
    public void Ui_view_model_denominator_is_selected_by_controlled_source_path_including_shell()
    {
        var report = ValidReport()
            .Replace("CodeSignAuto.App.UI.ViewModels.SampleViewModel", "CodeSignAuto.App.UI.ShellViewModel", StringComparison.Ordinal)
            .Replace("src/CodeSignAuto.App/UI/ViewModels/SampleViewModel.cs", "src/CodeSignAuto.App/UI/ShellViewModel.cs", StringComparison.Ordinal);
    ...
    private static string ValidReport() => Report(
        Package("CodeSignAuto.Core", "CodeSignAuto.Core.Sample", 17, 20),
        Package("CodeSignAuto.Service", "CodeSignAuto.Service.Sample", 17, 20),
        Package("CodeSignAuto.Protocol", "CodeSignAuto.Protocol.Sample", 17, 20),
        Package("CodeSignAuto.Agent", "CodeSignAuto.Agent.Sample", 15, 20),
        Package(
    ...
    [
        ...
        "CodeSignAuto.Core.Tests",
        "CodeSignAuto.EndToEnd.Tests",
        "CodeSignAuto.Protocol.Tests",
        "CodeSignAuto.Service.Tests",
        "CodeSignAuto.UI.Tests",
    ];

    private static readonly string[] ExpectedProjectFiles =
    [
        "tests/CodeSignAuto.Agent.Tests/CodeSignAuto.Agent.Tests.csproj",
        "tests/CodeSignAuto.Core.Tests/CodeSignAuto.Core.Tests.csproj",
        "tests/CodeSignAuto.EndToEnd.Tests/CodeSignAuto.EndToEnd.Tests.csproj",
        "tests/CodeSignAuto.Protocol.Tests/CodeSignAuto.Protocol.Tests.csproj",
        "tests/CodeSignAuto.Service.Tests/CodeSignAuto.Service.Tests.csproj",
        "tests/CodeSignAuto.UI.Tests/CodeSignAuto.UI.Tests.csproj",
    ];
    ...
    private static string CoverageHangFixturePath()
    {
        ...
        while (!File.Exists(Path.Combine(repository, "CodeSignAuto.sln")))
        {
