...
public sealed class NotificationPolicyTests
{
    ...
    public async Task Terminal_feed_updates_quick_sign_and_loaded_jobs_without_manual_refresh_or_navigation()
    {
        ...
        var source = Path.Combine(
            Path.GetTempPath(),
            $"SimplySignAuto-terminal-feed-{Guid.NewGuid():N}.exe");
        ...
        ILocalJobClient
    {
        ...
        public Task SaveOtpAsync(SimplySignAuto.Core.Otp.OtpauthProfile profile, CancellationToken cancellationToken) =>
            Task.CompletedTask;
