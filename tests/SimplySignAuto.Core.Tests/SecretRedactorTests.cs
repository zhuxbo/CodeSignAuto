...
public sealed class SecretRedactorTests
{
    ...
    public void Redacts_only_otpauth_secret_values_and_the_explicit_actual_secret()
    {
        ...
        const string input =
            "email=user@example.test path=C:\\ProgramData\\SimplySignAuto line=73 hresult=0x80004005 "
        ...
        Assert.Contains("email=user@example.test path=C:\\ProgramData\\SimplySignAuto line=73 hresult=0x80004005", redacted, StringComparison.Ordinal);
