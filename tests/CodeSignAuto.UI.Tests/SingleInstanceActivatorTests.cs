...
public sealed class SingleInstanceActivatorTests
{
    ...
    private const string CurrentExecutable = @"C:\Program Files\CodeSignAuto\CodeSignAuto.exe";
    ...
    public void Activation_server_identity_rejects_a_different_executable_or_user()
    {
        ...
        Assert.False(verifier.IsTrusted(
            trusted with { ExecutablePath = @"C:\Temp\CodeSignAuto.exe" },
            SigningSid,
            7,
            CurrentExecutable));
        Assert.False(verifier.IsTrusted(
    ...
    public void Activation_names_are_versioned_and_derived_without_exposing_the_sid()
    {
        ...
        Assert.Equal(
            "CodeSignAuto.Activation.v1.f051b5cbf3c10c7c27e426dc66de5275d4588f456c9875ed690e47ccda569634",
            names.PipeName);
        Assert.Equal("Local\\CodeSignAuto.Agent.S-1-5-21-1000", names.AgentMutexName);
