...
public sealed class DesktopManagementCompositionTests
{
    ...
    private sealed class MemoryOtpStore : CodeSignAuto.Agent.Security.IOtpStore
    {
        public string Path => "memory";

        public Task SaveAsync(CodeSignAuto.Core.Otp.OtpauthProfile profile, CancellationToken cancellationToken) =>
            Task.CompletedTask;

        public Task<CodeSignAuto.Core.Otp.OtpauthProfile> LoadAsync(CancellationToken cancellationToken) =>
            throw new NotSupportedException();
    }

    private sealed class StoredOtpStore(OtpauthProfile profile) : CodeSignAuto.Agent.Security.IOtpStore
    {
        public string Path => "memory";
