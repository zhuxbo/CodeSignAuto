...
{
    [Theory]
    [InlineData(ShellTheme.Light, "/CodeSignAuto;component/UI/Themes/Colors.Light.xaml")]
    [InlineData(ShellTheme.Dark, "/CodeSignAuto;component/UI/Themes/Colors.Dark.xaml")]
