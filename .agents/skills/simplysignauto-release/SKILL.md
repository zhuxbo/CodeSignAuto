---
name: simplysignauto-release
description: 在 SimplySignAuto 仓库中进行新会话上手、Windows 构建测试、安装卸载、签名发布、部署验证或发布前审计时使用。提供项目架构、主程序与 PDF 扩展边界、凭据安全要求、分阶段验证与发布门禁。
---

# SimplySignAuto 发布与验证
